...
public class JPushBridge {
    ...
    public boolean isPushStopped(String gameObject, String func) {
        UnityPlayer.UnitySendMessage(gameObject, func, "isPushStopped");
        return JPushInterface.isPushStopped(getActivity());
    }
